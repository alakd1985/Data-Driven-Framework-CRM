...
public class LeadTest extends TestBase {
	...
	public void leadTest(String salutation, String fname, String lname, String title, String organization,
			String status, String email, String phone, String mobile, String fax, String web, String industry,
			String emp, String leadsource, String street, String city, 
			String state, String postalcode, String country,String description)
